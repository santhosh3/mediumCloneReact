    ...
    <div className='navbar2'>
     ...
     <Link to="/" className="link  ">
      <svg
        ...
        style={{ paddingTop: "7px", width: "170px" }}
      >
      ...
      <div className='n2'>
        ...
        <div className='n23'>
          ...
          <div className='n24'>     
          <div class="dropdown">
          <button class="dropdown-toggle border border-white" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
